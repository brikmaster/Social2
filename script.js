class MultiPlatformSocialGenerator {
    constructor() {
        ...
        this.availableModels = [
            ...
            { provider: 'huggingface', model: 'mistralai/Mixtral-8x7B-Instruct-v0.1', name: 'Mixtral 8x7B Instruct' },
            { provider: 'huggingface', model: 'HuggingFaceH4/zephyr-7b-beta', name: 'Zephyr 7B Beta' }
        ];
